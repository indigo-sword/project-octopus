...
class TestApiUser(unittest.TestCase):    
    ...
    def test_change_user_bio(self):
        with self.subTest("change user bio"):
            ...
            response = session.post(url + "change_user_bio", data={
                "username": u,
                "bio": "I am Joao"
            })
    ...
    def test_follow_user(self):
        with self.subTest("follow user"):
            ...
            response = session.post(url + "follow_user", data={
                "username": u,
                "followed_username": f
            })
    ...
    def test_unfollow_user(self):
        with self.subTest("unfollow user"):
            ...
            session.post(url + "follow_user", data={
                "username": u,
                "followed_username": f
            })

            response = session.post(url + "unfollow_user", data={
                "username": u,
    ...
    def test_get_follows(self):
        with self.subTest(msg="follow user"):
            ...
            u = random_username()
            response = sessionU.post(url + "create_user", data={
                "username": u,
                "password": "password_4_joao",
                "email": random_email()
            })

            sessionU.post(url + "/login", data={
                "username": u,
                "password": "password_4_joao"
            })

            f = random_username()
            sessionF.post(url + "create_user", data={
                "username": f,
                "password": "password_4_joao",
                "email": random_email()
            })

            sessionF.post(url + "/login", data={
                "username": f,
                "password": "password_4_joao"
            })

            g = random_username()
            sessionG.post(url + "create_user", data={
                "username": g,
                "password": "password_4_joao",
                "email": random_email()
            })
            
            sessionG.post(url + "/login", data={
                "username": g,
                "password": "password_4_joao"
            })

            sessionU.post(url + "follow_user", data={
                "username": u,
                "followed_username": f
            })

            sessionF.post(url + "follow_user", data={
                "username": f,
                "followed_username": u
            })
            ...
            response = sessionU.get(url + "get_follows", data={
                "username": u
            })
        ...
        with self.subTest(msg="user not found"):
            ...
            response = session.get(url + "get_follows", data={
                "username": u
            })
    ...
    def test_add_friend(self):
        with self.subTest(msg="add friend"):
            ...
            response = session.post(url + "add_friend", data={
                "username": u,
                "friend_username": f
            })
        ...
        with self.subTest(msg="already friends"):  
            ...
            session.post(url + "add_friend", data={
                "username": u,
                "friend_username": f
            })

            sessionF.post(url + "accept_friend", data={
                "username": f,
                "friend_username": u
            })
        ...
        with self.subTest(msg="friend request already received from other user"):
            ...
            sessionF.post(url + "add_friend", data={
                "username": f,
                "friend_username": u
            })
    ...
    def test_accept_friend(self):
        with self.subTest(msg="accept friend"):
            ...
            response = sessionF.post(url + "accept_friend", data={
                "username": f,
                "friend_username": u
            })
        ...
        with self.subTest(msg="user not logged in"):
            ...
            response = session.post(url + "accept_friend", data={
                "username": random_username(),
                "friend_username": random_username()
            })
    ...
    def test_reject_friend(self):
        with self.subTest(msg="reject friend"):
            ...
            response = sessionF.post(url + "reject_friend", data={
                "username": f,
                "friend_username": u
            })
        ...
        with self.subTest(msg="user not logged in"):
            ...
            response = session.post(url + "reject_friend", data={
                "username": random_username(),
                "friend_username": random_username()
            })
    ...
    def test_remove_friend(self):
        with self.subTest(msg="remove friend"):
            ...
            response = session.post(url + "remove_friend", data={
                "username": u,
                "friend_username": f
            })
    ...
    def test_get_friends(self):
        with self.subTest(msg="get friends"):
            sessionU = requests.Session()
            u = random_username()
            sessionU.post(url + "create_user", data={
                "username": u,
                "password": "password_4_joao",
                "email": random_email()
            })
            ...
            h = random_username()
            sessionH.post(url + "create_user", data={
                "username": h,
                "password": "password_4_joao",
                "email": random_email()
            })

            sessionH.post(url + "/login", data={
                "username": h,
                "password": "password_4_joao"
            })
            ...
            i = random_username()
            sessionI.post(url + "create_user", data={
                "username": i,
                "password": "password_4_joao",
                "email": random_email()
            })

            sessionI.post(url + "/login", data={
                "username": i,
                "password": "password_4_joao"
            })
            ...
            j = random_username()
            sessionJ.post(url + "create_user", data={
                "username": j,
                "password": "password_4_joao",
                "email": random_email()
            })

            sessionJ.post(url + "/login", data={
                "username": j,
                "password": "password_4_joao"
            })

            sessionU.post(url + "add_friend", data={
                "username": u,
                "friend_username": f
            })
            ...
            # h added u
            sessionH.post(url + "add_friend", data={
                "username": h,
                "friend_username": u
            })

            # i adds u but u refuses
            sessionI.post(url + "add_friend", data={
                "username": i,
                "friend_username": u
            })

            sessionU.post(url + "reject_friend", data={
                "username": u,
                "friend_username": i
            })
            ...
            sessionJ.post(url + "reject_friend", data={
                "username": j,
                "friend_username": u
            })

            response = sessionU.get(url + "get_friends", data={
                "username": u
            })
        ...
        with self.subTest(msg="user not found"):
            ...
            response = session.get(url + "get_friends", data={
                "username": random_username()
            })
    ...
    def test_get_user(self):
        with self.subTest(msg="get user"):
            ...
            response = session.get(url + "get_user", data={
                "username": u
            })
