...
def get_follows_func(username: str):
    ...
    return {
        ...
        "following": u.get_following(db_session),
        "followed": u.get_followers(db_session),
    }, 200
...
def reject_friend_func(username: str, friend_username: str):
    ...
    try:
        u.reject_friend_request(db_session, f)
    except:
        return {"message": "no friend request from this user"}, 400
...
def get_friends_func(username: str):
    ...
    return {
        ...
        "friends": u.get_friends(db_session),
        "requests": u.get_friend_requests(db_session),
        "sent requests": u.get_friend_requests_sent(db_session),
    }, 200
...
def link_nodes_func(
    ...
    try:
        o.link(d, description, db_session)
...
def get_next_links_func(node_id: str):
    ...
    return {
        ...
        "next_links": [
            ...
            for link in n.get_next_links(db_session)
        ],
    }, 200
...
def get_previous_links_func(node_id: str):
    ...
    return {
        ...
        "previous_links": [
            ...
            for link in n.get_previous_links(db_session)
        ],
    }, 200
